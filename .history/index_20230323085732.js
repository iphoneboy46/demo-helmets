window.onload = () => {
  function activeProduct() {
    ...
    itemProduct1.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-1 > .item-list-img.active"
        );
    ...
    itemProduct2.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-2 > .item-list-img.active"
        );
    ...
    itemProduct3.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-3 > .item-list-img.active"
        );
    ...
    itemProduct4.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-4 > .item-list-img.active"
        );
    ...
    itemProduct5.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-5 > .item-list-img.active"
        );
        let itemProductAni = document.querySelector(
    ...
    itemProduct6.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-6 > .item-list-img.active"
        );
        let itemProductAni = document.querySelector(
    ...
    itemProduct7.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-7 > .item-list-img.active"
        );
        let itemProductAni = document.querySelector(
    ...
    itemProduct8.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-8 > .item-list-img.active"
        );
        let itemProductAni = document.querySelector(
    ...
    itemProduct9.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-9 > .item-list-img.active"
        );
        let itemProductAni = document.querySelector(
    ...
    itemProduct10.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-10 > .item-list-img.active"
        );
        let itemProductAni = document.querySelector(
    ...
    itemProduct11.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-11 > .item-list-img.active"
        );
        let itemProductAni = document.querySelector(
    ...
    itemProduct12.forEach((product, index) => {
      product.onclick = (e) => {
        let itemProductActive = document.querySelector(
          ".item-list.item-12 > .item-list-img.active"
        );
        let itemProductAni = document.querySelector(
  ...
  function activeLanguage(){
    ...
    listLanguage.forEach((language)=>{
      let listLanguageActive = document.querySelector(".header_language.active");
      listLanguage.onclick = () => {
        listLanguageActive.classList.remove("active");
        listLanguage.classList.add("active");
      }
    })
  }
};
