window.onload = () => {
  function activeProduct() {
    let imgProductImage1 = document.querySelector(".item.img-1 > img");
    let imgProductImage2 = document.querySelector(".item.img-2 > img");
