...
function sliderMobi() {
  let btnNext = document.querySelector(".btn-down-slider");
  let btnPrev = document.querySelector(".btn-up-slider");

  btnNext.onclick = () => {
    let itemSliders = document.querySelectorAll(".slider-item");
    let listItemSliders = document.querySelector(".slider-con-mobile");
    listItemSliders.appendChild(itemSliders[0]);
  };
